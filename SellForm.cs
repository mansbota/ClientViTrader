...
namespace ClientViTrader
{
    public partial class SellForm : Form
    {
        ...
        public SellForm(UserDTO user, CryptoDTO crypto, string serverURL, string coingeckoURL)
        {
            InitializeComponent();
            this.user = user;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            if (usdCheckBox.Checked)
            {
                ...
                SendSellRequest(decimal.Parse(usdTextBox.Text));
            }
            else
            {
                ...
                else
                {
                    ...
                    SendSellRequest(usdVal);
                }
            }
        }

        private void SendSellRequest(decimal usdAmount)
        {
            TradeDTO trade = new()
            {
                amount = usdAmount,
            ...
            {
                MessageBox.Show("Crypto sold", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
